    ...
    module Global
      class << self
        def load!
          ...
          load_object_extensions!
          load_string_extensions!
          load_enumerable_extensions!
          load_array_extensions!
          load_hash_extensions!
          load_integer_extensions!
        ...
        def load_enumerable_extensions!
